...
// **This account is Australian, so the .com.au host is the one that works.**
// Proven 18 August 2026: with the same certificate, the .com host answers
// CERT_AUTH_REQUIRED while .com.au gets past certificate auth. A certificate is
// registered against one jurisdiction, not both, so CERT_AUTH_REQUIRED from
// .com is expected and is not a sign of a bad certificate.
//
// The international host is kept as a fallback, tried second, so a jurisdiction
// change is one reorder rather than a rewrite.
