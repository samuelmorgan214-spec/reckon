...
create table if not exists markets (
  ...
  category text not null check (category in ('footy','sports','politics','economy','crypto','culture')),
...
insert into markets (slug, question, category, source_type, source_config) values
  ...
  ('nrl-premiership-2026-panthers', 'Panthers to win the 2026 NRL premiership', 'footy', 'bookmaker-consensus',
   '{"provider":"odds_api","sport":"rugbyleague_nrl_premiership_winner","market":"outrights","outcome":"Penrith Panthers"}'),
  ('afl-flag-2026-collingwood', 'Collingwood to win the 2026 AFL flag', 'footy', 'bookmaker-consensus',
   '{"provider":"odds_api","sport":"aussierules_afl_premiership_winner","market":"outrights","outcome":"Collingwood Magpies"}'),
  ('nrl-premiership-2026-storm', 'Storm to win the 2026 NRL premiership', 'footy', 'bookmaker-consensus',
   '{"provider":"odds_api","sport":"rugbyleague_nrl_premiership_winner","market":"outrights","outcome":"Melbourne Storm"}'),
  ('nrl-premiership-2026-broncos', 'Broncos to win the 2026 NRL premiership', 'footy', 'bookmaker-consensus',
   '{"provider":"odds_api","sport":"rugbyleague_nrl_premiership_winner","market":"outrights","outcome":"Brisbane Broncos"}'),
  ('nrl-premiership-2026-raiders', 'Raiders to win the 2026 NRL premiership', 'footy', 'bookmaker-consensus',
   '{"provider":"odds_api","sport":"rugbyleague_nrl_premiership_winner","market":"outrights","outcome":"Canberra Raiders"}'),
  ('afl-flag-2026-lions', 'Brisbane Lions to win the 2026 AFL flag', 'footy', 'bookmaker-consensus',
   '{"provider":"odds_api","sport":"aussierules_afl_premiership_winner","market":"outrights","outcome":"Brisbane Lions"}'),
  ('afl-flag-2026-carlton', 'Carlton to win the 2026 AFL flag', 'footy', 'bookmaker-consensus',
   '{"provider":"odds_api","sport":"aussierules_afl_premiership_winner","market":"outrights","outcome":"Carlton Blues"}'),
  ('afl-flag-2026-geelong', 'Geelong to win the 2026 AFL flag', 'footy', 'bookmaker-consensus',
   '{"provider":"odds_api","sport":"aussierules_afl_premiership_winner","market":"outrights","outcome":"Geelong Cats"}'),
  ('nsw-origin-game-three', 'NSW to win State of Origin game three', 'footy', 'manual',
   '{"provider":"manual","resolution":"match result, Origin game three"}'),
  ('richmond-wooden-spoon-2026', 'Richmond to take the AFL wooden spoon', 'footy', 'manual',
